...
//        }
    ...
    private void init(){
        TableRow.LayoutParams rowParam=new TableRow.LayoutParams(0, TableRow.LayoutParams.WRAP_CONTENT,1);
        for(int i=0;i<1;i++){
            ...
            for(int j=0;j<3;j++){
                ...
                tv.setHeight(150);
//                tv.setTextAppearance(this, R.style.personStyle);
                tv.setId(200 + i+j);
                linearLayout.addView(tv,rowParam);
            }
